...
import org.sa.rainbow.stitch.lib.RubisUtils;

/**
 * Helper to query RUBiS ACME model
 * 
 * @author gmoreno
 */
public class RubisModelHelper {
	...
	public RubisModelHelper(AcmeModelInstance model) {
		m_model = model;
	}
	...
	public int getCurrentDimmerLevel() {
        ...
        int level = RubisUtils.dimmerFactorToLevel(dimmer, dimmerLevels, dimmerMargin);
        return level;
    }
